...
public class ExtentReportTestNGDemo {
	...
	@BeforeClass
	public void setUp() {
		sparkReporter = new ExtentSparkReporter(".//ExtentReportTestNG.html");
	...
	public void demoTest() throws Exception {
		test = extent.createTest("OrangeHrm Site test");
		...
		test.pass(MediaEntityBuilder.createScreenCaptureFromPath("image.png").build());
